...
\\ Allow to backup your photos, make albums and share them.
\\ See  \url{https://docs.cozy.io/en/mobile/files.html} for details.
\end{justifying}
\begin{center}
...
See \url{https://owncloud.org/install/} for details.
\end{justifying}
\begin{center}
